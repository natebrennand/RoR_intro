...
class LecturesControllerTest < ActionController::TestCase
  ...
  test "should create lecture" do
    assert_difference('Lecture.count') do
      post :create, lecture: { attendance: @lecture.attendance, class_time: @lecture.class_time, subject: @lecture.subject }
    end
  ...
  test "should update lecture" do
    put :update, id: @lecture, lecture: { attendance: @lecture.attendance, class_time: @lecture.class_time, subject: @lecture.subject }
    assert_redirected_to lecture_path(assigns(:lecture))
  end
